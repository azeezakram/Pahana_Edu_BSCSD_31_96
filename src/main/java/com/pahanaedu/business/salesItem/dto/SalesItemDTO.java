package com.pahanaedu.business.salesItem.dto;
...
public class SalesItemDTO {
    ...
    private final Long salesHistoryId;
    private final Integer sellPrice;
    private final Integer unit;
    private final Integer subTotal;

    private SalesItemDTO(Builder builder) {
        this.id = builder.id;
        this.item = builder.item;
        this.salesHistoryId = builder.salesHistoryId;
    ...
    public static class Builder {
        ...
        public Builder salesHistoryId(Long salesHistoryId) {
        ...
        public SalesItemDTO build() {
            return new SalesItemDTO(this);
        }
    }
}
